...
private:
	...
	// Information on parameters and pointers to ParamInfo list
	int m_NParams;
	ParamInfo* m_pFirst;
	ParamInfo* m_pLast;
...
class FFGLParameterNames
{
public:
    const char* getNamePointer(int parameterID);
    void setName(int parameterID, std::string s);
